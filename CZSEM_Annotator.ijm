/*
	...
	+ v240624" Added HDBSD parameters to favorites.
 */
macro "Add Multiple Lines of CZSEM Metadata to Image" {
	macroL = "CZSEM_Annotator_v240624_f1.ijm";
	...
	if (indexOfArray(metaTags,"Detector: HDBSD",-1)>=0) fImageParams = Array.concat(fImageParams, "BSD Mode: ", "BSD Gain: ", "BSD Auto Range: ", "BSD Autolevel Mode: ");
	...
	if (imageDepth==24) colorChoices = Array.concat(colorChoices, colorChoicesStd, colorChoicesMaterials, colorChoicesMod, colorChoicesNeon);
